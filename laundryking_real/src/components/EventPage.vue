...
export default {
  data() {
    return {
      activeTab: 0,
      ongoingEvents: [
        { id: 1, subtitle: '품목할인', title: '대한민국 최저가<br>이불세탁 6,800원', description: '제습제도 챙겨드려요', image: '/images/images/icon-bed.png', backgroundColor: '#DEE8F7' },
        ...
        { id: 6, subtitle: '경품증정', title: '세탁왕에서만 열리는<br> 리뷰 이벤트라곰!', description: '스너글로 세탁받고 선물까지!', image: '/images/images/icon-bear.png', backgroundColor: '#E0F8EA' },
      ],
      endedEvents: [
